...
export default function About() {
  ...
  const team = [
    ...
    },
    {
      ...
      image:
        "https://media-exp1.licdn.com/dms/image/D5635AQGymMEwwHI9Zg/profile-framedphoto-shrink_800_800/0/1633704601184?e=1638442800&v=beta&t=RJjf-_yxL5qygGThABDip09lvlPuTaZYyDyypUIHvSs",
    },
    {
      name: "Raj Aryan",
  ...
  const features = [
    {
      ...
      description:
        "MovieNix is a movie streaming platform built on the Hedera network using the Hashgraph SDK",
      icon: <MovieCreationIcon />,
    },
    {
      name: "One-Time Buy",
      description:
        "Buy a movie through a one-click buy option and watch before it expires in 14 days!",
      icon: <ShoppingCartIcon />,
    },
    {
      name: "Pay Per Second (PPS)",
      description:
        "Or if you don't want to buy the whole movie, you can watch the movie at 0.01 hbar per second!",
      icon: (
        <img
          className="hbar"
          alt="hbar"
    ...
    <>
      ...
      >
        ...
        <ThemeProvider theme={darkTheme}>
          <Typography
            variant="h4"
            sx={{ color: "white", textAlign: "center", padding: "30px" }}
          >
            More about MovieNix
          </Typography>
          <Grid
          ...
          <Typography
            variant="h4"
            sx={{ color: "white", textAlign: "center", padding: "30px 10px" }}
          >
            TEAM ATREUS
          </Typography>
          <Grid
            ...
            {team.map((member) => (
              <Grid item xs={12} sm={6} md={4} lg={3}>
                ...
                >
                  ...
                  >
                    <Avatar src={member.image} sx={{ width: 70, height: 70 }} />
                  </div>
